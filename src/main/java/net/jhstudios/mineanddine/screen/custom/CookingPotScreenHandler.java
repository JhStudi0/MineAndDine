...
public class CookingPotScreenHandler extends ScreenHandler {
    ...
    public CookingPotScreenHandler(int syncId, PlayerInventory playerInventory, BlockPos pos) {
       this(syncId, playerInventory, playerInventory.player.getWorld().getBlockEntity(pos));
    }

    public CookingPotScreenHandler(int syncId, PlayerInventory playerInventory, BlockEntity blockEntity) {
